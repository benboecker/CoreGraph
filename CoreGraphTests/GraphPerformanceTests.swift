...
//			let shortestPath = graph.shortestPath(from: -35330, to: -39502, minimum: 5)
...
//		_measure("Sammelplatz 1 -> Sammelplatz 3") {
//			let shortestPath = graph.shortestPath(from: -39502, to: -39506, minimum: 1)
//			XCTAssertTrue(shortestPath.isExpected)
//		}
